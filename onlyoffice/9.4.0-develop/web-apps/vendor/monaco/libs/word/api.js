...
ApiDocument.prototype = new ApiDocumentContent();
...
ApiTable.prototype = new ApiTablePr();
...
* @extends {ApiFormBase}
*/
function ApiTextForm() {}

ApiTextForm.prototype = new ApiFormBase();
...
* @extends {ApiFormBase}
*/
function ApiComboBoxForm() {}

ApiComboBoxForm.prototype = new ApiFormBase();
...
* @extends {ApiFormBase}
*/
function ApiCheckBoxForm() {}

ApiCheckBoxForm.prototype = new ApiFormBase();
...
* @extends {ApiFormBase}
*/
function ApiPictureForm() {}

ApiPictureForm.prototype = new ApiFormBase();
...
* @extends {ApiFormBase}
*/
function ApiDateForm() {}

ApiDateForm.prototype = new ApiFormBase();
...
* @extends {ApiFormBase}
*/
function ApiComplexForm() {}

ApiComplexForm.prototype = new ApiFormBase();
...
* @extends {ApiFormBase}
*/
function ApiSignatureForm() {}

ApiSignatureForm.prototype = new ApiFormBase();
...
ApiTableRow.prototype = new ApiTableRowPr();

/**
* Class representing the table cell properties.
* @constructor
*/
function ApiTableCellPr() {}
...
ApiTableCell.prototype = new ApiTableCellPr();

/**
* Class representing the numbering properties.
* @constructor
*/
function ApiNumbering() {}

/**
* Class representing a reference to a specified level of the numbering.
* @constructor
*/
function ApiNumberingLevel() {}
...
* @extends {ApiTextPr}
*/
function ApiRangeTextPr() {}

ApiRangeTextPr.prototype = new ApiTextPr();
...
*/
ApiRange.prototype.AddHyperlink = function(sLink, sScreenTipText, sBookmarkName) { return new ApiHyperlink(); };
...
*/
ApiRange.prototype.GetText = function(options) { return ""; };
...
* @return {ApiParagraph[]}
*/
ApiRange.prototype.GetAllParagraphs = function() { return []; };
...
*
*/
ApiRange.prototype.SetColor = function(color) { return new ApiRange(); };
...
*
*/
ApiRange.prototype.SetShd = function(type, color) { return new ApiRange(); };
...
* @returns {ApiRange}
*/
ApiRange.prototype.GetRange = function(Start, End) { return new ApiRange(); };
...
* @returns {string}
*/
ApiRange.prototype.ToHtml = function(options) { return ""; };
...
* @since 9.4.0
*/
ApiInterface.prototype.CreateNumbering = function(sType) { return new ApiNumbering(); };
...
* :::note
* Values of <em>styleIndex</em> outside <b>1 - 48</b> are interpreted as a chart style id from the <em>cs:chartStyle</em> element (e.g. 201, 215, 284) and are available only for [ONLYOFFICE Docs Enterprise](docs-enterprise-prices.aspx?from=api) and [ONLYOFFICE Docs Developer](developer-edition-prices.aspx?from=api).
* :::
* @memberof Api
...
*/
ApiInterface.prototype.AutoColor = function() { return new ApiColor(); };
...
* @returns {boolean}
*/
ApiInterface.prototype.attachEvent = function(eventName, callback) { return true; };
...
* @returns {boolean}
*/
ApiInterface.prototype.detachEvent = function(eventName) { return true; };
...
* @returns {ApiParaPr}
*/
ApiInterface.prototype.CreateParaPr = function() { return new ApiParaPr(); };
...
* @returns {ApiTablePr}
*/
ApiInterface.prototype.CreateTablePr = function() { return new ApiTablePr(); };
...
*/
ApiInterface.prototype.CreateTableRowPr = function() { return new ApiTableRowPr(); };
...
*/
ApiInterface.prototype.CreateTableCellPr = function() { return new ApiTableCellPr(); };
...
*/
ApiInterface.prototype.CreateTableStylePr = function(sType) { return new ApiTableStylePr(); };
...
* @return {Drawing[]}  
*/
ApiDocumentContent.prototype.GetAllDrawingObjects = function() { return []; };
...
* @return {ApiShape[]}  
*/
ApiDocumentContent.prototype.GetAllShapes = function() { return []; };
...
* @return {ApiImage[]}  
*/
ApiDocumentContent.prototype.GetAllImages = function() { return []; };
...
* @return {ApiChart[]}  
*/
ApiDocumentContent.prototype.GetAllCharts = function() { return []; };
...
* @return {ApiOleObject[]}  
*/
ApiDocumentContent.prototype.GetAllOleObjects = function() { return []; };
...
* @return {ApiTable[]}
*/
ApiDocumentContent.prototype.GetAllTables = function() { return []; };
...
* @returns {boolean}
*/
ApiDocumentContent.prototype.IsFootnote = function() { return true; };
...
* @returns {boolean}
*/
ApiDocumentContent.prototype.IsEndnote = function() { return true; };
...
*/
ApiDocumentContent.prototype.SelectNoteReference = function() { return true; };
...
*/
ApiDocumentContent.prototype.MoveCursorToNoteReference = function(isBefore) { return true; };
...
* @since 9.4.0
*/
ApiDocumentContent.prototype.AddParagraph = function() { return new ApiParagraph(); };
...
*/
ApiDocumentContent.prototype.GetDocumentVisitor = function() { return new ApiDocumentVisitor(); };
...
*/
ApiDocument.prototype.GetStyle = function(styleName) { return new ApiStyle(); };
...
* @returns {ApiStyle}
*/
ApiDocument.prototype.CreateStyle = function(styleName, type) { return new ApiStyle(); };
...
*/
ApiDocument.prototype.GetAllContentControls = function() { return []; };
...
* @return {ApiDrawing[]}
*/
ApiDocument.prototype.GetDrawingsByName = function(ids) { return []; };
...
* @returns {ApiBlockLvlSdt[] | ApiInlineLvlSdt[]}
*/
ApiDocument.prototype.GetContentControlsByTag = function(sTag) { return []; };
...
* @returns {ApiForm[]}
*/
ApiDocument.prototype.GetFormsByTag = function(sTag) { return []; };
...
* @since 9.0.0
*/
ApiDocument.prototype.GetFormsByRole = function(role) { return []; };
...
* @since 9.0.0
*/
ApiDocument.prototype.GetFormsByKey = function(key) { return []; };
...
* @since 9.0.0
*/
ApiDocument.prototype.GetFormValueByKey = function(key) { return undefined; };
...
* @return {ApiSection[]}  
*/
ApiDocument.prototype.GetSections = function() { return []; };
...
* @return {ApiTable[]}
*/
ApiDocument.prototype.GetAllTablesOnPage = function(nPage) { return []; };
...
* @return {ApiRange[]}  
*/
ApiDocument.prototype.Search = function(sText, isMatchCase) { return []; };
...
* @returns {ApiForm[]}
*/
ApiDocument.prototype.GetAllForms = function() { return []; };
...
*
*/
ApiDocument.prototype.SetFormsHighlight = function(color) { return true; };
...
*/
ApiDocument.prototype.GetFormsHighlight = function() { return new ApiColor(); };
...
* @returns {ApiComment[]}
*/
ApiDocument.prototype.GetAllComments = function() { return []; };
...
* @returns {ApiParagraph[]}
*/
ApiDocument.prototype.GetAllNumberedParagraphs = function() { return []; };
...
* @returns {ApiParagraph[]}
*/
ApiDocument.prototype.GetAllHeadingParagraphs = function() { return []; };
...
* @returns {ApiParagraph[]}
*/
ApiDocument.prototype.GetFootnotesFirstParagraphs = function() { return []; };
...
* @returns {ApiParagraph[]}
*/
ApiDocument.prototype.GetEndNotesFirstParagraphs = function() { return []; };
...
* @returns {ApiParagraph[]}
*/
ApiDocument.prototype.GetAllCaptionParagraphs = function(sCaption) { return []; };
...
* @since 7.2.0
*/
ApiDocument.prototype.GetSelectedDrawings = function() { return []; };
...
*
*/
ApiDocument.prototype.SetControlsHighlight = function(color) { return true; };
...
* @returns {ApiColor | null} Returns the highlight color, or <em>null</em> if the highlight is disabled.
*/
ApiDocument.prototype.GetControlsHighlight = function() { return new ApiColor(); };
...
* @since 8.3.0
*/
ApiDocument.prototype.GetCurrentVisiblePages = function() { return []; };
...
* @returns {ApiStyle[]}
*/
ApiDocument.prototype.GetAllStyles = function() { return []; };
...
* @since 9.2.0
*/
ApiDocument.prototype.EnterText = function(sText) { return true; };
...
* @since 9.2.0
*/
ApiDocument.prototype.InsertParagraphBreak = function() { return true; };
...
* @since 9.2.0
*/
ApiDocument.prototype.MoveCursorLeft = function(count, addToSelect, byWords) { return true; };
...
* @since 9.2.0
*/
ApiDocument.prototype.MoveCursorRight = function(count, addToSelect, byWords) { return true; };
...
* @since 9.2.0
*/
ApiDocument.prototype.MoveCursorUp = function(count, addToSelect) { return true; };
...
* @since 9.2.0
*/
ApiDocument.prototype.MoveCursorDown = function(count, addToSelect) { return true; };
...
* @since 9.3.0
*/
ApiDocument.prototype.GetCurrentFootEndnote = function() { return new ApiDocumentContent(); };
...
* @since 9.4.0
*/
ApiDocument.prototype.CreateTable = function(rows, cols) { return new ApiTable(); };
...
* @since 9.4.0
*/
ApiDocument.prototype.CreateParagraph = function() { return new ApiParagraph(); };
...
* @since 9.0.4
*/
ApiDocument.prototype.GetInternalId = function() { return ""; };
...
* @returns {number}
*/
ApiDocument.prototype.GetElementsCount = function() { return 0; };
...
* @returns {?DocumentElement}
*/
ApiDocument.prototype.GetElement = function(nPos) { return new DocumentElement(); };
...
* @returns {boolean}
*/
ApiDocument.prototype.AddElement = function(nPos, oElement) { return true; };
...
* @returns {boolean} - returns false if oElement is unsupported.
*/
ApiDocument.prototype.Push = function(oElement) { return true; };
...
* @returns {boolean}
*/
ApiDocument.prototype.RemoveAllElements = function() { return true; };
...
* @returns {boolean}
*/
ApiDocument.prototype.RemoveElement = function(nPos) { return true; };
...
* @returns {DocumentElement[]}
*/
ApiDocument.prototype.GetContent = function(bGetCopies) { return []; };
...
* @return {Drawing[]}  
*/
ApiDocument.prototype.GetAllDrawingObjects = function() { return []; };
...
* @return {ApiShape[]}  
*/
ApiDocument.prototype.GetAllShapes = function() { return []; };
...
* @return {ApiImage[]}  
*/
ApiDocument.prototype.GetAllImages = function() { return []; };
...
* @return {ApiChart[]}  
*/
ApiDocument.prototype.GetAllCharts = function() { return []; };
...
* @return {ApiOleObject[]}  
*/
ApiDocument.prototype.GetAllOleObjects = function() { return []; };
...
* @return {ApiParagraph[]}
*/
ApiDocument.prototype.GetAllParagraphs = function() { return []; };
...
* @return {ApiTable[]}
*/
ApiDocument.prototype.GetAllTables = function() { return []; };
...
* @since 8.3.0
*/
ApiDocument.prototype.GetText = function(options) { return ""; };
...
* @since 9.4.0
*/
ApiDocument.prototype.SetText = function(text) { return new ApiRun(); };
...
* @since 9.0.0
*/
ApiDocument.prototype.GetCurrentParagraph = function() { return new ApiParagraph(); };
...
* @since 9.0.0
*/
ApiDocument.prototype.GetCurrentRun = function() { return new ApiRun(); };
...
* @returns {ApiBlockLvlSdt | ApiInlineLvlSdt | null}
*/
ApiDocument.prototype.GetCurrentContentControl = function() { return new ApiBlockLvlSdt(); };
...
* @returns {boolean}
*/
ApiDocument.prototype.IsFootnote = function() { return true; };
...
* @returns {boolean}
*/
ApiDocument.prototype.IsEndnote = function() { return true; };
...
* @returns {boolean} Returns true if the reference was selected successfully.
*/
ApiDocument.prototype.SelectNoteReference = function() { return true; };
...
* @returns {boolean} Returns <em>true</em> if the cursor was moved to the reference successfully.
*/
ApiDocument.prototype.MoveCursorToNoteReference = function(isBefore) { return true; };
...
* @since 9.4.0
*/
ApiDocument.prototype.AddParagraph = function() { return new ApiParagraph(); };
...
* @since 9.4.0
*/
ApiDocument.prototype.AddText = function(text) { return new ApiRun(); };
...
* @returns {ApiDocumentVisitor} A document visitor that can be used to inspect or process the document structure.
*/
ApiDocument.prototype.GetDocumentVisitor = function() { return new ApiDocumentVisitor(); };
...
* @returns {boolean}
*/
ApiParagraph.prototype.SetParaId = function(paraId) { return true; };
...
* @since 9.2.0
*/
ApiParagraph.prototype.GetParaId = function() { return 0; };
...
*/
ApiParagraph.prototype.AddHyperlink = function(sLink, sScreenTipText, sBookmarkName) { return new ApiHyperlink(); };
...
*/
ApiParagraph.prototype.GetAllContentControls = function() { return []; };
...
* @return {Drawing[]}  
*/
ApiParagraph.prototype.GetAllDrawingObjects = function() { return []; };
...
* @return {ApiShape[]}  
*/
ApiParagraph.prototype.GetAllShapes = function() { return []; };
...
* @return {ApiImage[]}  
*/
ApiParagraph.prototype.GetAllImages = function() { return []; };
...
* @return {ApiChart[]}  
*/
ApiParagraph.prototype.GetAllCharts = function() { return []; };
...
* @return {ApiOleObject[]}  
*/
ApiParagraph.prototype.GetAllOleObjects = function() { return []; };
...
* @return {ApiRange[]}  
*/
ApiParagraph.prototype.Search = function(sText, isMatchCase) { return []; };
...
* @returns {boolean}
*/
ApiParagraph.prototype.AddNumberedCrossRef = function(sRefType, oParaTo, bLink, bAboveBelow, sSepWith) { return true; };
...
* @returns {boolean}
*/
ApiParagraph.prototype.AddHeadingCrossRef = function(sRefType, oParaTo, bLink, bAboveBelow) { return true; };
...
* @returns {boolean}
*/
ApiParagraph.prototype.AddFootnoteCrossRef = function(sRefType, oParaTo, bLink, bAboveBelow) { return true; };
...
* @returns {boolean}
*/
ApiParagraph.prototype.AddEndnoteCrossRef = function(sRefType, oParaTo, bLink, bAboveBelow) { return true; };
...
* @returns {boolean}
*/
ApiParagraph.prototype.AddCaptionCrossRef = function(sCaption, sRefType, oParaTo, bLink, bAboveBelow) { return true; };
...
* @since 9.4.0
*/
ApiParagraph.prototype.AddPageBreakBefore = function() { return new ApiParagraph(); };
...
* @returns {string}
*/
ApiParagraph.prototype.ToHtml = function(options) { return ""; };
...
* @returns {boolean}
*/
ApiParagraph.prototype.SetStyle = function(oStyle) { return true; };
...
*/
ApiParagraph.prototype.GetStyle = function() { return new ApiStyle(); };
...
* @returns {boolean}
*/
ApiParagraph.prototype.SetContextualSpacing = function(isContextualSpacing) { return true; };
...
*/
ApiParagraph.prototype.GetContextualSpacing = function() { return true; };
...
* @returns {boolean}
*/
ApiParagraph.prototype.SetKeepLines = function(isKeepLines) { return true; };
...
*/
ApiParagraph.prototype.GetKeepLines = function() { return true; };
...
* @returns {boolean}
*/
ApiParagraph.prototype.SetKeepNext = function(isKeepNext) { return true; };
...
*/
ApiParagraph.prototype.GetKeepNext = function() { return true; };
...
* @returns {boolean}
*/
ApiParagraph.prototype.SetPageBreakBefore = function(isPageBreakBefore) { return true; };
...
* <em>false</em> if it is not, or <em>undefined</em> if the value is not set.
*/
ApiParagraph.prototype.GetPageBreakBefore = function() { return true; };
...
*
*/
ApiParagraph.prototype.SetShd = function(type, color) { return true; };
...
*/
ApiParagraph.prototype.GetShd = function() { return new Shd(); };
...
* @returns {boolean}
*/
ApiParagraph.prototype.SetBottomBorder = function(sType, nSize, nSpace, r, g, b) { return true; };
...
*/
ApiParagraph.prototype.GetBottomBorder = function() { return new Border(); };
...
* @returns {boolean}
*/
ApiParagraph.prototype.SetLeftBorder = function(sType, nSize, nSpace, r, g, b) { return true; };
...
*/
ApiParagraph.prototype.GetLeftBorder = function() { return new Border(); };
...
* @returns {boolean}
*/
ApiParagraph.prototype.SetRightBorder = function(sType, nSize, nSpace, r, g, b) { return true; };
...
*/
ApiParagraph.prototype.GetRightBorder = function() { return new Border(); };
...
* @returns {boolean}
*/
ApiParagraph.prototype.SetTopBorder = function(sType, nSize, nSpace, r, g, b) { return true; };
...
*/
ApiParagraph.prototype.GetTopBorder = function() { return new Border(); };
...
* @returns {boolean}
*/
ApiParagraph.prototype.SetBetweenBorder = function(sType, nSize, nSpace, r, g, b) { return true; };
...
*/
ApiParagraph.prototype.GetBetweenBorder = function() { return new Border(); };
...
* @returns {boolean}
*/
ApiParagraph.prototype.SetWidowControl = function(isWidowControl) { return true; };
...
* or <em>undefined</em> if the value is not set.
*/
ApiParagraph.prototype.GetWidowControl = function() { return true; };
...
* @returns {boolean}
*/
ApiParagraph.prototype.SetNumPr = function(oNumPr, nLvl) { return true; };
...
*/
ApiParagraph.prototype.GetNumPr = function() { return new ApiNumberingLevel(); };
...
*/
ApiRun.prototype.AddHyperlink = function(sLink, sScreenTipText, sBookmarkName) { return new ApiHyperlink(); };
...
*
*/
ApiRun.prototype.SetShd = function(type, color) { return new ApiTextPr(); };
...
* @returns {string}
*/
ApiRun.prototype.GetText = function(options) { return ""; };
...
* @since 8.1.0
*/
ApiRun.prototype.GetStyle = function() { return new ApiStyle(); };
...
* @since 8.1.0
*/
ApiRun.prototype.GetColor = function() { return new ApiColor(); };
...
* @since 8.1.0
*/
ApiRun.prototype.GetVertAlign = function() { return ""; };
...
* @since 8.1.0
*/
ApiRun.prototype.GetPosition = function() { return new hps(); };
...
* @since 8.1.0
*/
ApiRun.prototype.GetLanguage = function() { return ""; };
...
* @since 8.1.0
*/
ApiRun.prototype.GetShd = function() { return new Shd(); };
...
* @returns {number}
*/
ApiSection.prototype.GetColumnsCount = function() { return 0; };
...
* @returns {twips[]}
*/
ApiSection.prototype.GetColumnsWidths = function() { return []; };
...
* @returns {twips[]}
*/
ApiSection.prototype.GetColumnsSpaces = function() { return []; };
...
* @returns {boolean}
*/
ApiSection.prototype.SetPageMargins = function(left, top, right, bottom) { return true; };
...
* @since 9.4.0
*/
ApiSection.prototype.SetMargins = function(left, top, right, bottom) { return true; };
...
* @returns {ApiTableRow}
*/
ApiTable.prototype.GetRow = function(rowIndex) { return new ApiTableRow(); };
...
*/
ApiTable.prototype.GetCell = function(rowIndex, cellIndex) { return new ApiTableCell(); };
...
* @return {ApiTable[]}
*/
ApiTable.prototype.GetTables = function() { return []; };
...
* @return {ApiRange[]}  
*/
ApiTable.prototype.Search = function(sText, isMatchCase) { return []; };
...
*
*/
ApiTable.prototype.SetBackgroundColor = function(color) { return true; };
...
* @since 9.4.0
*/
ApiTable.prototype.GetAllCells = function() { return []; };
...
* @returns {boolean}
*/
ApiTable.prototype.SetStyleColBandSize = function(nCount) { return true; };
...
* @returns {boolean}
*/
ApiTable.prototype.SetStyleRowBandSize = function(nCount) { return true; };
...
* @returns {boolean}
*/
ApiTable.prototype.SetJc = function(sJcType) { return true; };
...
* @returns {boolean}
*/
ApiTable.prototype.SetShd = function(sType, r, g, b, isAuto) { return true; };
...
* @returns {boolean}
*/
ApiTable.prototype.SetTableBorderTop = function(sType, nSize, nSpace, r, g, b) { return true; };
...
* @returns {boolean}
*/
ApiTable.prototype.SetTableBorderBottom = function(sType, nSize, nSpace, r, g, b) { return true; };
...
* @returns {boolean}
*/
ApiTable.prototype.SetTableBorderLeft = function(sType, nSize, nSpace, r, g, b) { return true; };
...
* @returns {boolean}
*/
ApiTable.prototype.SetTableBorderRight = function(sType, nSize, nSpace, r, g, b) { return true; };
...
* @returns {boolean}
*/
ApiTable.prototype.SetTableBorderInsideH = function(sType, nSize, nSpace, r, g, b) { return true; };
...
* @returns {boolean}
*/
ApiTable.prototype.SetTableBorderInsideV = function(sType, nSize, nSpace, r, g, b) { return true; };
...
* @since 9.0.0
*/
ApiTable.prototype.SetTableBorderAll = function(sType, nSize, nSpace, r, g, b) { return true; };
...
* @returns {boolean}
*/
ApiTable.prototype.SetTableCellMarginBottom = function(nValue) { return true; };
...
* @returns {boolean}
*/
ApiTable.prototype.SetTableCellMarginLeft = function(nValue) { return true; };
...
* @returns {boolean}
*/
ApiTable.prototype.SetTableCellMarginRight = function(nValue) { return true; };
...
* @returns {boolean}
*/
ApiTable.prototype.SetTableCellMarginTop = function(nValue) { return true; };
...
* @returns {boolean}
*/
ApiTable.prototype.SetCellSpacing = function(nValue) { return true; };
...
* @returns {boolean}
*/
ApiTable.prototype.SetTableInd = function(nValue) { return true; };
...
* @returns {boolean}
*/
ApiTable.prototype.SetWidth = function(sType, nValue) { return true; };
...
* @returns {boolean}
*/
ApiTable.prototype.SetTableLayout = function(sType) { return true; };
...
* @return {boolean}
*/
ApiTable.prototype.SetTableTitle = function(sTitle) { return true; };
...
* @return {string}
*/
ApiTable.prototype.GetTableTitle = function() { return ""; };
...
* @return {boolean}
*/
ApiTable.prototype.SetTableDescription = function(sDescr) { return true; };
...
* @return {string}
*/
ApiTable.prototype.GetTableDescription = function() { return ""; };
...
* @returns {string}
*/
ApiTableRow.prototype.GetInternalId = function() { return ""; };
...
* @returns {ApiTableCell}
*/
ApiTableRow.prototype.GetCell = function(cellIndex) { return new ApiTableCell(); };
...
* @return {ApiRange[]}
*/
ApiTableRow.prototype.Search = function(sText, isMatchCase) { return []; };
...
*
*/
ApiTableRow.prototype.SetBackgroundColor = function(color) { return true; };
...
* @returns {boolean}
*/
ApiTableRow.prototype.SetHeight = function(sHRule, nValue) { return true; };
...
* @returns {boolean}
*/
ApiTableRow.prototype.SetTableHeader = function(isHeader) { return true; };
...
* @returns {JSON}
*/
ApiTableRow.prototype.ToJSON = function() { return new JSON(); };
...
* @returns {string}
*/
ApiTableCell.prototype.GetInternalId = function() { return ""; };
...
* @return {ApiRange[]}  
*/
ApiTableCell.prototype.Search = function(sText, isMatchCase) { return []; };
...
*
*/
ApiTableCell.prototype.SetBackgroundColor = function(color) { return true; };
...
* @since 9.1.0
*/
ApiTableCell.prototype.GetBackgroundColor = function() { return new ApiColor(); };
...
*
*/
ApiTableCell.prototype.SetColumnBackgroundColor = function(color) { return true; };
...
* @returns {boolean}
*/
ApiTableCell.prototype.SetShd = function(sType, r, g, b, isAuto) { return true; };
...
* @returns {boolean}
*/
ApiTableCell.prototype.SetCellBorderBottom = function(sType, nSize, nSpace, r, g, b) { return true; };
...
* @returns {boolean}
*/
ApiTableCell.prototype.SetCellBorderLeft = function(sType, nSize, nSpace, r, g, b) { return true; };
...
* @returns {boolean}
*/
ApiTableCell.prototype.SetCellBorderRight = function(sType, nSize, nSpace, r, g, b) { return true; };
...
* @returns {boolean}
*/
ApiTableCell.prototype.SetCellBorderTop = function(sType, nSize, nSpace, r, g, b) { return true; };
...
* @returns {boolean}
*/
ApiTableCell.prototype.SetWidth = function(sType, nValue) { return true; };
...
* @returns {boolean}
*/
ApiTableCell.prototype.SetNoWrap = function(isNoWrap) { return true; };
...
* @returns {JSON}
*/
ApiTableCell.prototype.ToJSON = function() { return new JSON(); };
...
*/
ApiStyle.prototype.SetTextPr = function(textPr) { return new ApiStyle(); };
...
* @returns {ApiStyle} - this
*/
ApiStyle.prototype.SetParaPr = function(paraPr) { return new ApiStyle(); };
...
* @returns {ApiStyle} - this
*/
ApiStyle.prototype.SetTablePr = function(tablePr) { return new ApiStyle(); };
...
* @returns {ApiStyle} - this
*/
ApiStyle.prototype.SetTableRowPr = function(tableRowPr) { return new ApiStyle(); };
...
* @returns {ApiStyle} - this
*/
ApiStyle.prototype.SetTableCellPr = function(tableCellPr) { return new ApiStyle(); };
...
*
*/
ApiTextPr.prototype.SetColor = function(color) { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiTextPr.prototype.GetColor = function() { return new ApiColor(); };
...
*
*/
ApiTextPr.prototype.SetShd = function(type, color) { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiTextPr.prototype.GetShd = function() { return new Shd(); };
...
* or <em>undefined</em> if the value is not set.
*/
ApiParaPr.prototype.GetContextualSpacing = function() { return true; };
...
* <em>false</em> if they are not, or <em>undefined</em> if the value is not set.
*/
ApiParaPr.prototype.GetKeepLines = function() { return true; };
...
* <em>false</em> if it is not, or <em>undefined</em> if the value is not set.
*/
ApiParaPr.prototype.GetKeepNext = function() { return true; };
...
* <em>false</em> if it is not, or <em>undefined</em> if the value is not set.
*/
ApiParaPr.prototype.GetPageBreakBefore = function() { return true; };
...
*
*/
ApiParaPr.prototype.SetShd = function(type, color) { return true; };
...
* @returns {Shd | undefined}
*/
ApiParaPr.prototype.GetShd = function() { return new Shd(); };
...
* @returns {Border | undefined} Returns the border properties object, or <em>undefined</em> if the bottom border is not set.
*/
ApiParaPr.prototype.GetBottomBorder = function() { return new Border(); };
...
* @returns {Border | undefined} Returns the border properties object, or <em>undefined</em> if the left border is not set.
*/
ApiParaPr.prototype.GetLeftBorder = function() { return new Border(); };
...
* @returns {Border | undefined} Returns the border properties object, or <em>undefined</em> if the right border is not set.
*/
ApiParaPr.prototype.GetRightBorder = function() { return new Border(); };
...
* @returns {Border | undefined} Returns the border properties object, or <em>undefined</em> if the top border is not set.
*/
ApiParaPr.prototype.GetTopBorder = function() { return new Border(); };
...
* @returns {Border | undefined} Returns the border properties object, or <em>undefined</em> if the between border is not set.
*/
ApiParaPr.prototype.GetBetweenBorder = function() { return new Border(); };
...
* or <em>undefined</em> if the value is not set.
*/
ApiParaPr.prototype.GetWidowControl = function() { return true; };
...
* @returns {ApiNumberingLevel | undefined}
*/
ApiParaPr.prototype.GetNumPr = function() { return new ApiNumberingLevel(); };
...
* 
*/
ApiDrawing.prototype.SetRelativeHeight = function(sRelativeFrom, nPercent) { return true; };
...
* 
*/
ApiDrawing.prototype.SetRelativeWidth = function(sRelativeFrom, nPercent) { return true; };
...
*
*/
ApiDrawing.prototype.SetHorPosition = function(sRelativeFrom, nDistance, bPercent) { return true; };
...
*
*/
ApiDrawing.prototype.SetVerPosition = function(sRelativeFrom, nDistance, bPercent) { return true; };
...
ApiDrawing.prototype.SetBackgroundColor = function() {};
...
* @returns {?ApiDocumentContent}
*/
ApiImage.prototype.GetContent = function() { return new ApiDocumentContent(); };
...
* @returns {boolean}
*/
ApiImage.prototype.SetSize = function(nWidth, nHeight) { return true; };
...
* 
*/
ApiImage.prototype.SetRelativeHeight = function(sRelativeFrom, nPercent) { return true; };
...
* 
*/
ApiImage.prototype.SetRelativeWidth = function(sRelativeFrom, nPercent) { return true; };
...
* @returns {boolean}
*/
ApiImage.prototype.SetWrappingStyle = function(sType) { return true; };
...
* @returns {boolean}
*/
ApiImage.prototype.SetHorAlign = function(sRelativeFrom, sAlign) { return true; };
...
* @returns {boolean}
*/
ApiImage.prototype.SetVerAlign = function(sRelativeFrom, sAlign) { return true; };
...
*
*/
ApiImage.prototype.SetHorPosition = function(sRelativeFrom, nDistance, bPercent) { return true; };
...
*
*/
ApiImage.prototype.SetVerPosition = function(sRelativeFrom, nDistance, bPercent) { return true; };
...
* @returns {boolean}
*/
ApiImage.prototype.SetDistances = function(nLeft, nTop, nRight, nBottom) { return true; };
...
* @return {ApiParagraph | null} - returns null if parent paragraph doesn't exist.
*/
ApiImage.prototype.GetParentParagraph = function() { return new ApiParagraph(); };
...
* @return {ApiBlockLvlSdt | null} - returns null if parent content control doesn't exist.
*/
ApiImage.prototype.GetParentContentControl = function() { return new ApiBlockLvlSdt(); };
...
* @return {ApiTable | null} - returns null if parent table doesn't exist.
*/
ApiImage.prototype.GetParentTable = function() { return new ApiTable(); };
...
* @return {ApiTableCell | null} - returns null if parent cell doesn't exist.
*/
ApiImage.prototype.GetParentTableCell = function() { return new ApiTableCell(); };
...
* @return {ApiDrawing | ApiBlockLvlSdt}  
*/
ApiImage.prototype.InsertInContentControl = function(nType) { return new ApiDrawing(); };
...
* @return {ApiParagraph | ApiDrawing} - returns null if parent paragraph doesn't exist.
*/
ApiImage.prototype.InsertParagraph = function(paragraph, sPosition, beRNewPara) { return new ApiParagraph(); };
...
* @returns {boolean}  - returns false if drawing object haven't parent run or params are invalid.
*/
ApiImage.prototype.AddBreak = function(breakType, position) { return true; };
...
* @returns {boolean}
*/
ApiImage.prototype.SetHorFlip = function(bFlip) { return true; };
...
* @returns {boolean} - returns false if param is invalid.
*/
ApiImage.prototype.SetVertFlip = function(bFlip) { return true; };
...
* @returns {boolean} - return false if param is invalid.
*/
ApiImage.prototype.ScaleHeight = function(coefficient) { return true; };
...
* @returns {boolean} - return false if param is invali.
*/
ApiImage.prototype.ScaleWidth = function(coefficient) { return true; };
...
* @returns {ApiDrawing | null} - returns null if drawing object is last.
*/
ApiImage.prototype.GetNextDrawing = function() { return new ApiDrawing(); };
...
* @returns {ApiDrawing | null} - returns null if drawing object is first.
*/
ApiImage.prototype.GetPrevDrawing = function() { return new ApiDrawing(); };
...
* @returns {JSON}
*/
ApiImage.prototype.ToJSON = function(bWriteNumberings, bWriteStyles) { return new JSON(); };
...
* @returns {boolean}
*/
ApiImage.prototype.SetDrawingPrFromDrawing = function(oAnotherDrawing) { return true; };
...
ApiImage.prototype.SetBackgroundColor = function() {};
...
* @returns {?ApiDocumentContent}
*/
ApiOleObject.prototype.GetContent = function() { return new ApiDocumentContent(); };
...
* @returns {boolean}
*/
ApiOleObject.prototype.SetSize = function(nWidth, nHeight) { return true; };
...
* 
*/
ApiOleObject.prototype.SetRelativeHeight = function(sRelativeFrom, nPercent) { return true; };
...
* 
*/
ApiOleObject.prototype.SetRelativeWidth = function(sRelativeFrom, nPercent) { return true; };
...
* @returns {boolean}
*/
ApiOleObject.prototype.SetWrappingStyle = function(sType) { return true; };
...
* @returns {boolean}
*/
ApiOleObject.prototype.SetHorAlign = function(sRelativeFrom, sAlign) { return true; };
...
* @returns {boolean}
*/
ApiOleObject.prototype.SetVerAlign = function(sRelativeFrom, sAlign) { return true; };
...
*
*/
ApiOleObject.prototype.SetHorPosition = function(sRelativeFrom, nDistance, bPercent) { return true; };
...
*
*/
ApiOleObject.prototype.SetVerPosition = function(sRelativeFrom, nDistance, bPercent) { return true; };
...
* @returns {boolean}
*/
ApiOleObject.prototype.SetDistances = function(nLeft, nTop, nRight, nBottom) { return true; };
...
* @return {ApiParagraph | null} - returns null if parent paragraph doesn't exist.
*/
ApiOleObject.prototype.GetParentParagraph = function() { return new ApiParagraph(); };
...
* @return {ApiBlockLvlSdt | null} - returns null if parent content control doesn't exist.
*/
ApiOleObject.prototype.GetParentContentControl = function() { return new ApiBlockLvlSdt(); };
...
* @return {ApiTable | null} - returns null if parent table doesn't exist.
*/
ApiOleObject.prototype.GetParentTable = function() { return new ApiTable(); };
...
* @return {ApiTableCell | null} - returns null if parent cell doesn't exist.
*/
ApiOleObject.prototype.GetParentTableCell = function() { return new ApiTableCell(); };
...
* @return {ApiDrawing | ApiBlockLvlSdt}  
*/
ApiOleObject.prototype.InsertInContentControl = function(nType) { return new ApiDrawing(); };
...
* @return {ApiParagraph | ApiDrawing} - returns null if parent paragraph doesn't exist.
*/
ApiOleObject.prototype.InsertParagraph = function(paragraph, sPosition, beRNewPara) { return new ApiParagraph(); };
...
* @returns {boolean}  - returns false if drawing object haven't parent run or params are invalid.
*/
ApiOleObject.prototype.AddBreak = function(breakType, position) { return true; };
...
* @returns {boolean}
*/
ApiOleObject.prototype.SetHorFlip = function(bFlip) { return true; };
...
* @returns {boolean} - returns false if param is invalid.
*/
ApiOleObject.prototype.SetVertFlip = function(bFlip) { return true; };
...
* @returns {boolean} - return false if param is invalid.
*/
ApiOleObject.prototype.ScaleHeight = function(coefficient) { return true; };
...
* @returns {boolean} - return false if param is invali.
*/
ApiOleObject.prototype.ScaleWidth = function(coefficient) { return true; };
...
* @returns {ApiDrawing | null} - returns null if drawing object is last.
*/
ApiOleObject.prototype.GetNextDrawing = function() { return new ApiDrawing(); };
...
* @returns {ApiDrawing | null} - returns null if drawing object is first.
*/
ApiOleObject.prototype.GetPrevDrawing = function() { return new ApiDrawing(); };
...
* @returns {JSON}
*/
ApiOleObject.prototype.ToJSON = function(bWriteNumberings, bWriteStyles) { return new JSON(); };
...
* @returns {boolean}
*/
ApiOleObject.prototype.SetDrawingPrFromDrawing = function(oAnotherDrawing) { return true; };
...
ApiOleObject.prototype.SetBackgroundColor = function() {};
...
* @returns {boolean}
*/
ApiShape.prototype.SetSize = function(nWidth, nHeight) { return true; };
...
* 
*/
ApiShape.prototype.SetRelativeHeight = function(sRelativeFrom, nPercent) { return true; };
...
* 
*/
ApiShape.prototype.SetRelativeWidth = function(sRelativeFrom, nPercent) { return true; };
...
* @returns {boolean}
*/
ApiShape.prototype.SetWrappingStyle = function(sType) { return true; };
...
* @returns {boolean}
*/
ApiShape.prototype.SetHorAlign = function(sRelativeFrom, sAlign) { return true; };
...
* @returns {boolean}
*/
ApiShape.prototype.SetVerAlign = function(sRelativeFrom, sAlign) { return true; };
...
*
*/
ApiShape.prototype.SetHorPosition = function(sRelativeFrom, nDistance, bPercent) { return true; };
...
*
*/
ApiShape.prototype.SetVerPosition = function(sRelativeFrom, nDistance, bPercent) { return true; };
...
* @returns {boolean}
*/
ApiShape.prototype.SetDistances = function(nLeft, nTop, nRight, nBottom) { return true; };
...
* @return {ApiParagraph | null} - returns null if parent paragraph doesn't exist.
*/
ApiShape.prototype.GetParentParagraph = function() { return new ApiParagraph(); };
...
* @return {ApiBlockLvlSdt | null} - returns null if parent content control doesn't exist.
*/
ApiShape.prototype.GetParentContentControl = function() { return new ApiBlockLvlSdt(); };
...
* @return {ApiTable | null} - returns null if parent table doesn't exist.
*/
ApiShape.prototype.GetParentTable = function() { return new ApiTable(); };
...
* @return {ApiTableCell | null} - returns null if parent cell doesn't exist.
*/
ApiShape.prototype.GetParentTableCell = function() { return new ApiTableCell(); };
...
* @return {ApiDrawing | ApiBlockLvlSdt}  
*/
ApiShape.prototype.InsertInContentControl = function(nType) { return new ApiDrawing(); };
...
* @return {ApiParagraph | ApiDrawing} - returns null if parent paragraph doesn't exist.
*/
ApiShape.prototype.InsertParagraph = function(paragraph, sPosition, beRNewPara) { return new ApiParagraph(); };
...
* @returns {boolean}  - returns false if drawing object haven't parent run or params are invalid.
*/
ApiShape.prototype.AddBreak = function(breakType, position) { return true; };
...
* @returns {boolean}
*/
ApiShape.prototype.SetHorFlip = function(bFlip) { return true; };
...
* @returns {boolean} - returns false if param is invalid.
*/
ApiShape.prototype.SetVertFlip = function(bFlip) { return true; };
...
* @returns {boolean} - return false if param is invalid.
*/
ApiShape.prototype.ScaleHeight = function(coefficient) { return true; };
...
* @returns {boolean} - return false if param is invali.
*/
ApiShape.prototype.ScaleWidth = function(coefficient) { return true; };
...
* @returns {ApiDrawing | null} - returns null if drawing object is last.
*/
ApiShape.prototype.GetNextDrawing = function() { return new ApiDrawing(); };
...
* @returns {ApiDrawing | null} - returns null if drawing object is first.
*/
ApiShape.prototype.GetPrevDrawing = function() { return new ApiDrawing(); };
...
* @returns {JSON}
*/
ApiShape.prototype.ToJSON = function(bWriteNumberings, bWriteStyles) { return new JSON(); };
...
* @returns {boolean}
*/
ApiShape.prototype.SetDrawingPrFromDrawing = function(oAnotherDrawing) { return true; };
...
ApiShape.prototype.SetBackgroundColor = function() {};
...
* @returns {?ApiDocumentContent}
*/
ApiChart.prototype.GetContent = function() { return new ApiDocumentContent(); };
...
* @returns {boolean}
*/
ApiChart.prototype.SetSize = function(nWidth, nHeight) { return true; };
...
* 
*/
ApiChart.prototype.SetRelativeHeight = function(sRelativeFrom, nPercent) { return true; };
...
* 
*/
ApiChart.prototype.SetRelativeWidth = function(sRelativeFrom, nPercent) { return true; };
...
* @returns {boolean}
*/
ApiChart.prototype.SetWrappingStyle = function(sType) { return true; };
...
* @returns {boolean}
*/
ApiChart.prototype.SetHorAlign = function(sRelativeFrom, sAlign) { return true; };
...
* @returns {boolean}
*/
ApiChart.prototype.SetVerAlign = function(sRelativeFrom, sAlign) { return true; };
...
*
*/
ApiChart.prototype.SetHorPosition = function(sRelativeFrom, nDistance, bPercent) { return true; };
...
*
*/
ApiChart.prototype.SetVerPosition = function(sRelativeFrom, nDistance, bPercent) { return true; };
...
* @returns {boolean}
*/
ApiChart.prototype.SetDistances = function(nLeft, nTop, nRight, nBottom) { return true; };
...
* @return {ApiParagraph | null} - returns null if parent paragraph doesn't exist.
*/
ApiChart.prototype.GetParentParagraph = function() { return new ApiParagraph(); };
...
* @return {ApiBlockLvlSdt | null} - returns null if parent content control doesn't exist.
*/
ApiChart.prototype.GetParentContentControl = function() { return new ApiBlockLvlSdt(); };
...
* @return {ApiTable | null} - returns null if parent table doesn't exist.
*/
ApiChart.prototype.GetParentTable = function() { return new ApiTable(); };
...
* @return {ApiTableCell | null} - returns null if parent cell doesn't exist.
*/
ApiChart.prototype.GetParentTableCell = function() { return new ApiTableCell(); };
...
* @return {ApiDrawing | ApiBlockLvlSdt}  
*/
ApiChart.prototype.InsertInContentControl = function(nType) { return new ApiDrawing(); };
...
* @return {ApiParagraph | ApiDrawing} - returns null if parent paragraph doesn't exist.
*/
ApiChart.prototype.InsertParagraph = function(paragraph, sPosition, beRNewPara) { return new ApiParagraph(); };
...
* @returns {boolean}  - returns false if drawing object haven't parent run or params are invalid.
*/
ApiChart.prototype.AddBreak = function(breakType, position) { return true; };
...
* @returns {boolean}
*/
ApiChart.prototype.SetHorFlip = function(bFlip) { return true; };
...
* @returns {boolean} - returns false if param is invalid.
*/
ApiChart.prototype.SetVertFlip = function(bFlip) { return true; };
...
* @returns {boolean} - return false if param is invalid.
*/
ApiChart.prototype.ScaleHeight = function(coefficient) { return true; };
...
* @returns {boolean} - return false if param is invali.
*/
ApiChart.prototype.ScaleWidth = function(coefficient) { return true; };
...
* @returns {ApiDrawing | null} - returns null if drawing object is last.
*/
ApiChart.prototype.GetNextDrawing = function() { return new ApiDrawing(); };
...
* @returns {ApiDrawing | null} - returns null if drawing object is first.
*/
ApiChart.prototype.GetPrevDrawing = function() { return new ApiDrawing(); };
...
* @returns {JSON}
*/
ApiChart.prototype.ToJSON = function(bWriteNumberings, bWriteStyles) { return new JSON(); };
...
* @returns {boolean}
*/
ApiChart.prototype.SetDrawingPrFromDrawing = function(oAnotherDrawing) { return true; };
...
ApiChart.prototype.SetBackgroundColor = function() {};
...
* @returns {?ApiDocumentContent}
*/
ApiGroup.prototype.GetContent = function() { return new ApiDocumentContent(); };
...
* @returns {boolean}
*/
ApiGroup.prototype.SetSize = function(nWidth, nHeight) { return true; };
...
* 
*/
ApiGroup.prototype.SetRelativeHeight = function(sRelativeFrom, nPercent) { return true; };
...
* 
*/
ApiGroup.prototype.SetRelativeWidth = function(sRelativeFrom, nPercent) { return true; };
...
* @returns {boolean}
*/
ApiGroup.prototype.SetWrappingStyle = function(sType) { return true; };
...
* @returns {boolean}
*/
ApiGroup.prototype.SetHorAlign = function(sRelativeFrom, sAlign) { return true; };
...
* @returns {boolean}
*/
ApiGroup.prototype.SetVerAlign = function(sRelativeFrom, sAlign) { return true; };
...
*
*/
ApiGroup.prototype.SetHorPosition = function(sRelativeFrom, nDistance, bPercent) { return true; };
...
*
*/
ApiGroup.prototype.SetVerPosition = function(sRelativeFrom, nDistance, bPercent) { return true; };
...
* @returns {boolean}
*/
ApiGroup.prototype.SetDistances = function(nLeft, nTop, nRight, nBottom) { return true; };
...
* @return {ApiParagraph | null} - returns null if parent paragraph doesn't exist.
*/
ApiGroup.prototype.GetParentParagraph = function() { return new ApiParagraph(); };
...
* @return {ApiBlockLvlSdt | null} - returns null if parent content control doesn't exist.
*/
ApiGroup.prototype.GetParentContentControl = function() { return new ApiBlockLvlSdt(); };
...
* @return {ApiTable | null} - returns null if parent table doesn't exist.
*/
ApiGroup.prototype.GetParentTable = function() { return new ApiTable(); };
...
* @return {ApiTableCell | null} - returns null if parent cell doesn't exist.
*/
ApiGroup.prototype.GetParentTableCell = function() { return new ApiTableCell(); };
...
* @return {ApiDrawing | ApiBlockLvlSdt}  
*/
ApiGroup.prototype.InsertInContentControl = function(nType) { return new ApiDrawing(); };
...
* @return {ApiParagraph | ApiDrawing} - returns null if parent paragraph doesn't exist.
*/
ApiGroup.prototype.InsertParagraph = function(paragraph, sPosition, beRNewPara) { return new ApiParagraph(); };
...
* @returns {boolean}  - returns false if drawing object haven't parent run or params are invalid.
*/
ApiGroup.prototype.AddBreak = function(breakType, position) { return true; };
...
* @returns {boolean}
*/
ApiGroup.prototype.SetHorFlip = function(bFlip) { return true; };
...
* @returns {boolean} - returns false if param is invalid.
*/
ApiGroup.prototype.SetVertFlip = function(bFlip) { return true; };
...
* @returns {boolean} - return false if param is invalid.
*/
ApiGroup.prototype.ScaleHeight = function(coefficient) { return true; };
...
* @returns {boolean} - return false if param is invali.
*/
ApiGroup.prototype.ScaleWidth = function(coefficient) { return true; };
...
* @returns {ApiDrawing | null} - returns null if drawing object is last.
*/
ApiGroup.prototype.GetNextDrawing = function() { return new ApiDrawing(); };
...
* @returns {ApiDrawing | null} - returns null if drawing object is first.
*/
ApiGroup.prototype.GetPrevDrawing = function() { return new ApiDrawing(); };
...
* @returns {JSON}
*/
ApiGroup.prototype.ToJSON = function(bWriteNumberings, bWriteStyles) { return new JSON(); };
...
* @returns {boolean}
*/
ApiGroup.prototype.SetDrawingPrFromDrawing = function(oAnotherDrawing) { return true; };
...
ApiGroup.prototype.SetBackgroundColor = function() {};
...
* @returns {?ApiDocumentContent}
*/
ApiSmartArt.prototype.GetContent = function() { return new ApiDocumentContent(); };
...
* @returns {boolean}
*/
ApiSmartArt.prototype.SetSize = function(nWidth, nHeight) { return true; };
...
* 
*/
ApiSmartArt.prototype.SetRelativeHeight = function(sRelativeFrom, nPercent) { return true; };
...
* 
*/
ApiSmartArt.prototype.SetRelativeWidth = function(sRelativeFrom, nPercent) { return true; };
...
* @returns {boolean}
*/
ApiSmartArt.prototype.SetWrappingStyle = function(sType) { return true; };
...
* @returns {boolean}
*/
ApiSmartArt.prototype.SetHorAlign = function(sRelativeFrom, sAlign) { return true; };
...
* @returns {boolean}
*/
ApiSmartArt.prototype.SetVerAlign = function(sRelativeFrom, sAlign) { return true; };
...
*
*/
ApiSmartArt.prototype.SetHorPosition = function(sRelativeFrom, nDistance, bPercent) { return true; };
...
*
*/
ApiSmartArt.prototype.SetVerPosition = function(sRelativeFrom, nDistance, bPercent) { return true; };
...
* @returns {boolean}
*/
ApiSmartArt.prototype.SetDistances = function(nLeft, nTop, nRight, nBottom) { return true; };
...
* @return {ApiParagraph | null} - returns null if parent paragraph doesn't exist.
*/
ApiSmartArt.prototype.GetParentParagraph = function() { return new ApiParagraph(); };
...
* @return {ApiBlockLvlSdt | null} - returns null if parent content control doesn't exist.
*/
ApiSmartArt.prototype.GetParentContentControl = function() { return new ApiBlockLvlSdt(); };
...
* @return {ApiTable | null} - returns null if parent table doesn't exist.
*/
ApiSmartArt.prototype.GetParentTable = function() { return new ApiTable(); };
...
* @return {ApiTableCell | null} - returns null if parent cell doesn't exist.
*/
ApiSmartArt.prototype.GetParentTableCell = function() { return new ApiTableCell(); };
...
* @return {ApiDrawing | ApiBlockLvlSdt}  
*/
ApiSmartArt.prototype.InsertInContentControl = function(nType) { return new ApiDrawing(); };
...
* @return {ApiParagraph | ApiDrawing} - returns null if parent paragraph doesn't exist.
*/
ApiSmartArt.prototype.InsertParagraph = function(paragraph, sPosition, beRNewPara) { return new ApiParagraph(); };
...
* @returns {boolean}  - returns false if drawing object haven't parent run or params are invalid.
*/
ApiSmartArt.prototype.AddBreak = function(breakType, position) { return true; };
...
* @returns {boolean}
*/
ApiSmartArt.prototype.SetHorFlip = function(bFlip) { return true; };
...
* @returns {boolean} - returns false if param is invalid.
*/
ApiSmartArt.prototype.SetVertFlip = function(bFlip) { return true; };
...
* @returns {boolean} - return false if param is invalid.
*/
ApiSmartArt.prototype.ScaleHeight = function(coefficient) { return true; };
...
* @returns {boolean} - return false if param is invali.
*/
ApiSmartArt.prototype.ScaleWidth = function(coefficient) { return true; };
...
* @returns {ApiDrawing | null} - returns null if drawing object is last.
*/
ApiSmartArt.prototype.GetNextDrawing = function() { return new ApiDrawing(); };
...
* @returns {ApiDrawing | null} - returns null if drawing object is first.
*/
ApiSmartArt.prototype.GetPrevDrawing = function() { return new ApiDrawing(); };
...
* @returns {JSON}
*/
ApiSmartArt.prototype.ToJSON = function(bWriteNumberings, bWriteStyles) { return new JSON(); };
...
* @returns {boolean}
*/
ApiSmartArt.prototype.SetDrawingPrFromDrawing = function(oAnotherDrawing) { return true; };
...
ApiSmartArt.prototype.SetBackgroundColor = function() {};
...
* @returns {number}
*/
ApiRGBColor.prototype.GetRGB = function() { return 0; };
...
* @returns {number}
*/
ApiSchemeColor.prototype.GetRGB = function() { return 0; };
...
* @returns {number}
*/
ApiPresetColor.prototype.GetRGB = function() { return 0; };
...
* @returns {boolean}
*/
ApiColor.prototype.IsAutoColor = function() { return true; };
...
* @returns {boolean}
*/
ApiInlineLvlSdt.prototype.SetLabel = function(label) { return true; };
...
* @returns {number}
*/
ApiInlineLvlSdt.prototype.GetLabel = function() { return 0; };
...
* @returns {boolean} - returns false if param is invalid.
*/
ApiInlineLvlSdt.prototype.AddText = function(text) { return true; };
...
*
*/
ApiInlineLvlSdt.prototype.SetBorderColor = function(color) { return true; };
...
* @returns {?ApiColor}
*/
ApiInlineLvlSdt.prototype.GetBorderColor = function() { return new ApiColor(); };
...
*
*/
ApiInlineLvlSdt.prototype.SetBackgroundColor = function(color) { return true; };
...
* @returns {?ApiColor}
*/
ApiInlineLvlSdt.prototype.GetBackgroundColor = function() { return new ApiColor(); };
...
* @returns {boolean}
*/
ApiInlineLvlSdt.prototype.SetColor = function(color) { return true; };
...
*/
ApiInlineLvlSdt.prototype.GetColor = function() { return new ApiColor(); };
...
*/
ApiContentControlList.prototype.GetAllItems = function() { return []; };
...
* @returns {boolean}
*/
ApiBlockLvlSdt.prototype.SetLock = function(lockType) { return true; };
...
* @returns {number}
*/
ApiBlockLvlSdt.prototype.GetLabel = function() { return 0; };
...
* @returns {boolean} Returns `true` if the update was successful, otherwise `false`.
*/
ApiBlockLvlSdt.prototype.UpdateFromXmlMapping = function() { return true; };
...
* @returns {string} The string data representing the contents of the current content control.
*/
ApiBlockLvlSdt.prototype.GetDataForXmlMapping = function() { return ""; };
...
* @returns {ApiBlockLvlSdt[] | ApiInlineLvlSdt[]}
*/
ApiBlockLvlSdt.prototype.GetAllContentControls = function() { return []; };
...
* @returns {ApiParagraph[]}
*/
ApiBlockLvlSdt.prototype.GetAllParagraphs = function() { return []; };
...
* @return {ApiTable[]}  
*/
ApiBlockLvlSdt.prototype.GetAllTablesOnPage = function(page) { return []; };
...
* @return {Drawing[]}  
*/
ApiBlockLvlSdt.prototype.GetAllDrawingObjects = function() { return []; };
...
* @return {ApiRange[]}  
*/
ApiBlockLvlSdt.prototype.Search = function(text, isMatchCase) { return []; };
...
* @return {boolean}
*/
ApiBlockLvlSdt.prototype.SetBorderColor = function(color) { return true; };
...
* @returns {?ApiColor}
*/
ApiBlockLvlSdt.prototype.GetBorderColor = function() { return new ApiColor(); };
...
* @return {boolean}
*/
ApiBlockLvlSdt.prototype.SetBackgroundColor = function(color) { return true; };
...
* @returns {?ApiColor}
*/
ApiBlockLvlSdt.prototype.GetBackgroundColor = function() { return new ApiColor(); };
...
*/
ApiBlockLvlSdt.prototype.GetAppearance = function() { return ""; };
...
* @returns {string}
*/
ApiFormBase.prototype.GetInternalId = function() { return ""; };
...
*
*/
ApiFormBase.prototype.SetBorderColor = function(color) { return true; };
...
* @since 9.1.0
*/
ApiFormBase.prototype.GetBorderColor = function() { return new ApiColor(); };
...
*
*/
ApiFormBase.prototype.SetBackgroundColor = function(color) { return true; };
...
* @since 9.1.0
*/
ApiFormBase.prototype.GetBackgroundColor = function() { return new ApiColor(); };
...
* @since 9.4.0
*/
ApiFormBase.prototype.IsFilled = function() { return true; };
...
* @returns {string}
*/
ApiFormBase.prototype.GetPlaceholderText = function() { return ""; };
...
*/
ApiFormBase.prototype.Delete = function(keepContent) { return true; };
...
*/
ApiFormBase.prototype.SetLock = function(isLock) { return true; };
...
* @returns {boolean}
*/
ApiFormBase.prototype.GetLock = function() { return true; };
...
* @since 9.4.0
*/
ApiFormBase.prototype.GetValue = function() { return ""; };
...
* @since 9.4.0
*/
ApiFormBase.prototype.SetValue = function(value) { return true; };
...
*/
ApiTextForm.prototype.GetFormat = function() { return new TextFormFormat(); };
...
* @returns {boolean}
*/
ApiTextForm.prototype.SetFormat = function(format) { return true; };
...
* @returns {string}
*/
ApiTextForm.prototype.GetAllowedSymbols = function() { return ""; };
...
* @returns {boolean}
*/
ApiTextForm.prototype.SetAllowedSymbols = function(symbols) { return true; };
...
* @returns {boolean}
*/
ApiTextForm.prototype.SetText = function(text) { return true; };
...
* @since 9.4.0
*/
ApiTextForm.prototype.GetValue = function() { return ""; };
...
* @since 9.4.0
*/
ApiTextForm.prototype.SetValue = function(value) { return true; };
...
* @returns {string}
*/
ApiTextForm.prototype.GetInternalId = function() { return ""; };
...
* @returns {FormType}
*/
ApiTextForm.prototype.GetFormType = function() { return new FormType(); };
...
* @returns {string}
*/
ApiTextForm.prototype.GetFormKey = function() { return ""; };
...
* @returns {boolean}
*/
ApiTextForm.prototype.SetFormKey = function(sKey) { return true; };
...
* @returns {string}
*/
ApiTextForm.prototype.GetTipText = function() { return ""; };
...
* @returns {boolean}
*/
ApiTextForm.prototype.SetTipText = function(sText) { return true; };
...
* @returns {boolean}
*/
ApiTextForm.prototype.IsRequired = function() { return true; };
...
* @returns {boolean}
*/
ApiTextForm.prototype.SetRequired = function(bRequired) { return true; };
...
* @returns {boolean}
*/
ApiTextForm.prototype.IsFixed = function() { return true; };
...
* @returns {boolean}
*/
ApiTextForm.prototype.ToFixed = function(width, height, keepPosition) { return true; };
...
* @returns {boolean}
*/
ApiTextForm.prototype.ToInline = function() { return true; };
...
*
*/
ApiTextForm.prototype.SetBorderColor = function(color) { return true; };
...
* @since 9.1.0
*/
ApiTextForm.prototype.GetBorderColor = function() { return new ApiColor(); };
...
*
*/
ApiTextForm.prototype.SetBackgroundColor = function(color) { return true; };
...
* @since 9.1.0
*/
ApiTextForm.prototype.GetBackgroundColor = function() { return new ApiColor(); };
...
* @returns {string}
*/
ApiTextForm.prototype.GetText = function() { return ""; };
...
* @since 9.4.0
*/
ApiTextForm.prototype.IsFilled = function() { return true; };
...
* @returns {boolean}
*/
ApiTextForm.prototype.Clear = function() { return true; };
...
* @returns {?ApiShape} - returns the shape in which the form is placed.
*/
ApiTextForm.prototype.GetWrapperShape = function() { return new ApiShape(); };
...
* @returns {boolean}
*/
ApiTextForm.prototype.SetPlaceholderText = function(sText) { return true; };
...
* @returns {string}
*/
ApiTextForm.prototype.GetPlaceholderText = function() { return ""; };
...
* @return {boolean}  
*/
ApiTextForm.prototype.SetTextPr = function(textPr) { return true; };
...
* @return {ApiTextPr}  
*/
ApiTextForm.prototype.GetTextPr = function() { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiTextForm.prototype.MoveCursorOutside = function(isAfter) { return true; };
...
* @returns {?ApiForm}
*/
ApiTextForm.prototype.Copy = function() { return new ApiForm(); };
...
* @returns {string}
*/
ApiTextForm.prototype.GetTag = function() { return ""; };
...
* @returns {boolean}
*/
ApiTextForm.prototype.SetTag = function(tag) { return true; };
...
* @returns {string}
*/
ApiTextForm.prototype.GetRole = function() { return ""; };
...
* @returns {boolean}
*/
ApiTextForm.prototype.SetRole = function(role) { return true; };
...
* @returns {boolean} - returns false if form wasn't added to the document.
*/
ApiTextForm.prototype.Delete = function(keepContent) { return true; };
...
* @returns {boolean} Returns true if the operation is successful.
*/
ApiTextForm.prototype.SetLock = function(isLock) { return true; };
...
* @returns {boolean}
*/
ApiTextForm.prototype.GetLock = function() { return true; };
...
* @returns {boolean}
*/
ApiPictureForm.prototype.SetImage = function(imageSrc) { return true; };
...
* @since 9.4.0
*/
ApiPictureForm.prototype.GetValue = function() { return ""; };
...
* @since 9.4.0
*/
ApiPictureForm.prototype.SetValue = function(value) { return true; };
...
* @returns {string}
*/
ApiPictureForm.prototype.GetInternalId = function() { return ""; };
...
* @returns {FormType}
*/
ApiPictureForm.prototype.GetFormType = function() { return new FormType(); };
...
* @returns {string}
*/
ApiPictureForm.prototype.GetFormKey = function() { return ""; };
...
* @returns {boolean}
*/
ApiPictureForm.prototype.SetFormKey = function(sKey) { return true; };
...
* @returns {string}
*/
ApiPictureForm.prototype.GetTipText = function() { return ""; };
...
* @returns {boolean}
*/
ApiPictureForm.prototype.SetTipText = function(sText) { return true; };
...
* @returns {boolean}
*/
ApiPictureForm.prototype.IsRequired = function() { return true; };
...
* @returns {boolean}
*/
ApiPictureForm.prototype.SetRequired = function(bRequired) { return true; };
...
* @returns {boolean}
*/
ApiPictureForm.prototype.IsFixed = function() { return true; };
...
* @returns {boolean}
*/
ApiPictureForm.prototype.ToFixed = function(width, height, keepPosition) { return true; };
...
* @returns {boolean}
*/
ApiPictureForm.prototype.ToInline = function() { return true; };
...
*
*/
ApiPictureForm.prototype.SetBorderColor = function(color) { return true; };
...
* @since 9.1.0
*/
ApiPictureForm.prototype.GetBorderColor = function() { return new ApiColor(); };
...
*
*/
ApiPictureForm.prototype.SetBackgroundColor = function(color) { return true; };
...
* @since 9.1.0
*/
ApiPictureForm.prototype.GetBackgroundColor = function() { return new ApiColor(); };
...
* @returns {string}
*/
ApiPictureForm.prototype.GetText = function() { return ""; };
...
* @since 9.4.0
*/
ApiPictureForm.prototype.IsFilled = function() { return true; };
...
* @returns {boolean}
*/
ApiPictureForm.prototype.Clear = function() { return true; };
...
* @returns {?ApiShape} - returns the shape in which the form is placed.
*/
ApiPictureForm.prototype.GetWrapperShape = function() { return new ApiShape(); };
...
* @returns {boolean}
*/
ApiPictureForm.prototype.SetPlaceholderText = function(sText) { return true; };
...
* @returns {string}
*/
ApiPictureForm.prototype.GetPlaceholderText = function() { return ""; };
...
* @return {boolean}  
*/
ApiPictureForm.prototype.SetTextPr = function(textPr) { return true; };
...
* @return {ApiTextPr}  
*/
ApiPictureForm.prototype.GetTextPr = function() { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiPictureForm.prototype.MoveCursorOutside = function(isAfter) { return true; };
...
* @returns {?ApiForm}
*/
ApiPictureForm.prototype.Copy = function() { return new ApiForm(); };
...
* @returns {string}
*/
ApiPictureForm.prototype.GetTag = function() { return ""; };
...
* @returns {boolean}
*/
ApiPictureForm.prototype.SetTag = function(tag) { return true; };
...
* @returns {string}
*/
ApiPictureForm.prototype.GetRole = function() { return ""; };
...
* @returns {boolean}
*/
ApiPictureForm.prototype.SetRole = function(role) { return true; };
...
* @returns {boolean} - returns false if form wasn't added to the document.
*/
ApiPictureForm.prototype.Delete = function(keepContent) { return true; };
...
* @returns {boolean} Returns true if the operation is successful.
*/
ApiPictureForm.prototype.SetLock = function(isLock) { return true; };
...
* @returns {boolean}
*/
ApiPictureForm.prototype.GetLock = function() { return true; };
...
* @since 9.4.0
*/
ApiComboBoxForm.prototype.GetValue = function() { return ""; };
...
* @since 9.4.0
*/
ApiComboBoxForm.prototype.SetValue = function(value) { return true; };
...
* @returns {string}
*/
ApiComboBoxForm.prototype.GetInternalId = function() { return ""; };
...
* @returns {FormType}
*/
ApiComboBoxForm.prototype.GetFormType = function() { return new FormType(); };
...
* @returns {string}
*/
ApiComboBoxForm.prototype.GetFormKey = function() { return ""; };
...
* @returns {boolean}
*/
ApiComboBoxForm.prototype.SetFormKey = function(sKey) { return true; };
...
* @returns {string}
*/
ApiComboBoxForm.prototype.GetTipText = function() { return ""; };
...
* @returns {boolean}
*/
ApiComboBoxForm.prototype.SetTipText = function(sText) { return true; };
...
* @returns {boolean}
*/
ApiComboBoxForm.prototype.IsRequired = function() { return true; };
...
* @returns {boolean}
*/
ApiComboBoxForm.prototype.SetRequired = function(bRequired) { return true; };
...
* @returns {boolean}
*/
ApiComboBoxForm.prototype.IsFixed = function() { return true; };
...
* @returns {boolean}
*/
ApiComboBoxForm.prototype.ToFixed = function(width, height, keepPosition) { return true; };
...
* @returns {boolean}
*/
ApiComboBoxForm.prototype.ToInline = function() { return true; };
...
*
*/
ApiComboBoxForm.prototype.SetBorderColor = function(color) { return true; };
...
* @since 9.1.0
*/
ApiComboBoxForm.prototype.GetBorderColor = function() { return new ApiColor(); };
...
*
*/
ApiComboBoxForm.prototype.SetBackgroundColor = function(color) { return true; };
...
* @since 9.1.0
*/
ApiComboBoxForm.prototype.GetBackgroundColor = function() { return new ApiColor(); };
...
* @returns {string}
*/
ApiComboBoxForm.prototype.GetText = function() { return ""; };
...
* @since 9.4.0
*/
ApiComboBoxForm.prototype.IsFilled = function() { return true; };
...
* @returns {boolean}
*/
ApiComboBoxForm.prototype.Clear = function() { return true; };
...
* @returns {?ApiShape} - returns the shape in which the form is placed.
*/
ApiComboBoxForm.prototype.GetWrapperShape = function() { return new ApiShape(); };
...
* @returns {boolean}
*/
ApiComboBoxForm.prototype.SetPlaceholderText = function(sText) { return true; };
...
* @returns {string}
*/
ApiComboBoxForm.prototype.GetPlaceholderText = function() { return ""; };
...
* @return {boolean}  
*/
ApiComboBoxForm.prototype.SetTextPr = function(textPr) { return true; };
...
* @return {ApiTextPr}  
*/
ApiComboBoxForm.prototype.GetTextPr = function() { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiComboBoxForm.prototype.MoveCursorOutside = function(isAfter) { return true; };
...
* @returns {?ApiForm}
*/
ApiComboBoxForm.prototype.Copy = function() { return new ApiForm(); };
...
* @returns {string}
*/
ApiComboBoxForm.prototype.GetTag = function() { return ""; };
...
* @returns {boolean}
*/
ApiComboBoxForm.prototype.SetTag = function(tag) { return true; };
...
* @returns {string}
*/
ApiComboBoxForm.prototype.GetRole = function() { return ""; };
...
* @returns {boolean}
*/
ApiComboBoxForm.prototype.SetRole = function(role) { return true; };
...
* @returns {boolean} - returns false if form wasn't added to the document.
*/
ApiComboBoxForm.prototype.Delete = function(keepContent) { return true; };
...
* @returns {boolean} Returns true if the operation is successful.
*/
ApiComboBoxForm.prototype.SetLock = function(isLock) { return true; };
...
* @returns {boolean}
*/
ApiComboBoxForm.prototype.GetLock = function() { return true; };
...
* @returns {boolean}
*/
ApiCheckBoxForm.prototype.SetLabel = function(label) { return true; };
...
* @returns {string}
*/
ApiCheckBoxForm.prototype.GetLabel = function() { return ""; };
...
* @since 9.4.0
*/
ApiCheckBoxForm.prototype.GetValue = function() { return true; };
...
* @since 9.4.0
*/
ApiCheckBoxForm.prototype.SetValue = function(value) { return true; };
...
* @since 9.4.0
*/
ApiCheckBoxForm.prototype.GetGroupValue = function() { return ""; };
...
* @since 9.4.0
*/
ApiCheckBoxForm.prototype.SetGroupValue = function(value) { return true; };
...
* @returns {string}
*/
ApiCheckBoxForm.prototype.GetInternalId = function() { return ""; };
...
* @returns {FormType}
*/
ApiCheckBoxForm.prototype.GetFormType = function() { return new FormType(); };
...
* @returns {string}
*/
ApiCheckBoxForm.prototype.GetFormKey = function() { return ""; };
...
* @returns {boolean}
*/
ApiCheckBoxForm.prototype.SetFormKey = function(sKey) { return true; };
...
* @returns {string}
*/
ApiCheckBoxForm.prototype.GetTipText = function() { return ""; };
...
* @returns {boolean}
*/
ApiCheckBoxForm.prototype.SetTipText = function(sText) { return true; };
...
* @returns {boolean}
*/
ApiCheckBoxForm.prototype.IsRequired = function() { return true; };
...
* @returns {boolean}
*/
ApiCheckBoxForm.prototype.SetRequired = function(bRequired) { return true; };
...
* @returns {boolean}
*/
ApiCheckBoxForm.prototype.IsFixed = function() { return true; };
...
* @returns {boolean}
*/
ApiCheckBoxForm.prototype.ToFixed = function(width, height, keepPosition) { return true; };
...
* @returns {boolean}
*/
ApiCheckBoxForm.prototype.ToInline = function() { return true; };
...
*
*/
ApiCheckBoxForm.prototype.SetBorderColor = function(color) { return true; };
...
* @since 9.1.0
*/
ApiCheckBoxForm.prototype.GetBorderColor = function() { return new ApiColor(); };
...
*
*/
ApiCheckBoxForm.prototype.SetBackgroundColor = function(color) { return true; };
...
* @since 9.1.0
*/
ApiCheckBoxForm.prototype.GetBackgroundColor = function() { return new ApiColor(); };
...
* @returns {string}
*/
ApiCheckBoxForm.prototype.GetText = function() { return ""; };
...
* @since 9.4.0
*/
ApiCheckBoxForm.prototype.IsFilled = function() { return true; };
...
* @returns {boolean}
*/
ApiCheckBoxForm.prototype.Clear = function() { return true; };
...
* @returns {?ApiShape} - returns the shape in which the form is placed.
*/
ApiCheckBoxForm.prototype.GetWrapperShape = function() { return new ApiShape(); };
...
* @returns {boolean}
*/
ApiCheckBoxForm.prototype.SetPlaceholderText = function(sText) { return true; };
...
* @returns {string}
*/
ApiCheckBoxForm.prototype.GetPlaceholderText = function() { return ""; };
...
* @return {boolean}  
*/
ApiCheckBoxForm.prototype.SetTextPr = function(textPr) { return true; };
...
* @return {ApiTextPr}  
*/
ApiCheckBoxForm.prototype.GetTextPr = function() { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiCheckBoxForm.prototype.MoveCursorOutside = function(isAfter) { return true; };
...
* @returns {?ApiForm}
*/
ApiCheckBoxForm.prototype.Copy = function() { return new ApiForm(); };
...
* @returns {string}
*/
ApiCheckBoxForm.prototype.GetTag = function() { return ""; };
...
* @returns {boolean}
*/
ApiCheckBoxForm.prototype.SetTag = function(tag) { return true; };
...
* @returns {string}
*/
ApiCheckBoxForm.prototype.GetRole = function() { return ""; };
...
* @returns {boolean}
*/
ApiCheckBoxForm.prototype.SetRole = function(role) { return true; };
...
* @returns {boolean} - returns false if form wasn't added to the document.
*/
ApiCheckBoxForm.prototype.Delete = function(keepContent) { return true; };
...
* @returns {boolean} Returns true if the operation is successful.
*/
ApiCheckBoxForm.prototype.SetLock = function(isLock) { return true; };
...
* @returns {boolean}
*/
ApiCheckBoxForm.prototype.GetLock = function() { return true; };
...
* @since 9.4.0
*/
ApiDateForm.prototype.GetValue = function() { return new Date(); };
...
* @since 9.4.0
*/
ApiDateForm.prototype.SetValue = function(value) { return true; };
...
* @returns {string}
*/
ApiDateForm.prototype.GetInternalId = function() { return ""; };
...
* @returns {FormType}
*/
ApiDateForm.prototype.GetFormType = function() { return new FormType(); };
...
* @returns {string}
*/
ApiDateForm.prototype.GetFormKey = function() { return ""; };
...
* @returns {boolean}
*/
ApiDateForm.prototype.SetFormKey = function(sKey) { return true; };
...
* @returns {string}
*/
ApiDateForm.prototype.GetTipText = function() { return ""; };
...
* @returns {boolean}
*/
ApiDateForm.prototype.SetTipText = function(sText) { return true; };
...
* @returns {boolean}
*/
ApiDateForm.prototype.IsRequired = function() { return true; };
...
* @returns {boolean}
*/
ApiDateForm.prototype.SetRequired = function(bRequired) { return true; };
...
* @returns {boolean}
*/
ApiDateForm.prototype.IsFixed = function() { return true; };
...
* @returns {boolean}
*/
ApiDateForm.prototype.ToFixed = function(width, height, keepPosition) { return true; };
...
* @returns {boolean}
*/
ApiDateForm.prototype.ToInline = function() { return true; };
...
*
*/
ApiDateForm.prototype.SetBorderColor = function(color) { return true; };
...
* @since 9.1.0
*/
ApiDateForm.prototype.GetBorderColor = function() { return new ApiColor(); };
...
*
*/
ApiDateForm.prototype.SetBackgroundColor = function(color) { return true; };
...
* @since 9.1.0
*/
ApiDateForm.prototype.GetBackgroundColor = function() { return new ApiColor(); };
...
* @returns {string}
*/
ApiDateForm.prototype.GetText = function() { return ""; };
...
* @since 9.4.0
*/
ApiDateForm.prototype.IsFilled = function() { return true; };
...
* @returns {boolean}
*/
ApiDateForm.prototype.Clear = function() { return true; };
...
* @returns {?ApiShape} - returns the shape in which the form is placed.
*/
ApiDateForm.prototype.GetWrapperShape = function() { return new ApiShape(); };
...
* @returns {boolean}
*/
ApiDateForm.prototype.SetPlaceholderText = function(sText) { return true; };
...
* @returns {string}
*/
ApiDateForm.prototype.GetPlaceholderText = function() { return ""; };
...
* @return {boolean}  
*/
ApiDateForm.prototype.SetTextPr = function(textPr) { return true; };
...
* @return {ApiTextPr}  
*/
ApiDateForm.prototype.GetTextPr = function() { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiDateForm.prototype.MoveCursorOutside = function(isAfter) { return true; };
...
* @returns {?ApiForm}
*/
ApiDateForm.prototype.Copy = function() { return new ApiForm(); };
...
* @returns {string}
*/
ApiDateForm.prototype.GetTag = function() { return ""; };
...
* @returns {boolean}
*/
ApiDateForm.prototype.SetTag = function(tag) { return true; };
...
* @returns {string}
*/
ApiDateForm.prototype.GetRole = function() { return ""; };
...
* @returns {boolean}
*/
ApiDateForm.prototype.SetRole = function(role) { return true; };
...
* @returns {boolean} - returns false if form wasn't added to the document.
*/
ApiDateForm.prototype.Delete = function(keepContent) { return true; };
...
* @returns {boolean} Returns true if the operation is successful.
*/
ApiDateForm.prototype.SetLock = function(isLock) { return true; };
...
* @returns {boolean}
*/
ApiDateForm.prototype.GetLock = function() { return true; };
...
* @since 9.0.0
*/
ApiComplexForm.prototype.GetSubForms = function() { return []; };
...
* @since 9.4.0
*/
ApiComplexForm.prototype.GetValue = function() { return ""; };
...
* @returns {string}
*/
ApiComplexForm.prototype.GetInternalId = function() { return ""; };
...
* @returns {FormType}
*/
ApiComplexForm.prototype.GetFormType = function() { return new FormType(); };
...
* @returns {string}
*/
ApiComplexForm.prototype.GetFormKey = function() { return ""; };
...
* @returns {boolean}
*/
ApiComplexForm.prototype.SetFormKey = function(sKey) { return true; };
...
* @returns {string}
*/
ApiComplexForm.prototype.GetTipText = function() { return ""; };
...
* @returns {boolean}
*/
ApiComplexForm.prototype.SetTipText = function(sText) { return true; };
...
* @returns {boolean}
*/
ApiComplexForm.prototype.IsRequired = function() { return true; };
...
* @returns {boolean}
*/
ApiComplexForm.prototype.SetRequired = function(bRequired) { return true; };
...
* @returns {boolean}
*/
ApiComplexForm.prototype.IsFixed = function() { return true; };
...
* @returns {boolean}
*/
ApiComplexForm.prototype.ToFixed = function(width, height, keepPosition) { return true; };
...
* @returns {boolean}
*/
ApiComplexForm.prototype.ToInline = function() { return true; };
...
*
*/
ApiComplexForm.prototype.SetBorderColor = function(color) { return true; };
...
* @since 9.1.0
*/
ApiComplexForm.prototype.GetBorderColor = function() { return new ApiColor(); };
...
*
*/
ApiComplexForm.prototype.SetBackgroundColor = function(color) { return true; };
...
* @since 9.1.0
*/
ApiComplexForm.prototype.GetBackgroundColor = function() { return new ApiColor(); };
...
* @returns {string}
*/
ApiComplexForm.prototype.GetText = function() { return ""; };
...
* @since 9.4.0
*/
ApiComplexForm.prototype.IsFilled = function() { return true; };
...
* @returns {boolean}
*/
ApiComplexForm.prototype.Clear = function() { return true; };
...
* @returns {?ApiShape} - returns the shape in which the form is placed.
*/
ApiComplexForm.prototype.GetWrapperShape = function() { return new ApiShape(); };
...
* @returns {boolean}
*/
ApiComplexForm.prototype.SetPlaceholderText = function(sText) { return true; };
...
* @returns {string}
*/
ApiComplexForm.prototype.GetPlaceholderText = function() { return ""; };
...
* @return {boolean}  
*/
ApiComplexForm.prototype.SetTextPr = function(textPr) { return true; };
...
* @return {ApiTextPr}  
*/
ApiComplexForm.prototype.GetTextPr = function() { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiComplexForm.prototype.MoveCursorOutside = function(isAfter) { return true; };
...
* @returns {?ApiForm}
*/
ApiComplexForm.prototype.Copy = function() { return new ApiForm(); };
...
* @returns {string}
*/
ApiComplexForm.prototype.GetTag = function() { return ""; };
...
* @returns {boolean}
*/
ApiComplexForm.prototype.SetTag = function(tag) { return true; };
...
* @returns {string}
*/
ApiComplexForm.prototype.GetRole = function() { return ""; };
...
* @returns {boolean}
*/
ApiComplexForm.prototype.SetRole = function(role) { return true; };
...
* @returns {boolean} - returns false if form wasn't added to the document.
*/
ApiComplexForm.prototype.Delete = function(keepContent) { return true; };
...
* @returns {boolean} Returns true if the operation is successful.
*/
ApiComplexForm.prototype.SetLock = function(isLock) { return true; };
...
* @returns {boolean}
*/
ApiComplexForm.prototype.GetLock = function() { return true; };
...
* @since 9.4.0
*/
ApiComplexForm.prototype.SetValue = function(value) { return true; };
...
* @since 9.4.0
*/
ApiSignatureForm.prototype.GetClassType = function() { return ""; };
...
* @since 9.4.0
*/
ApiSignatureForm.prototype.GetValue = function() { return ""; };
...
* @since 9.4.0
*/
ApiSignatureForm.prototype.SetValue = function(value) { return true; };
...
* @returns {string}
*/
ApiSignatureForm.prototype.GetInternalId = function() { return ""; };
...
* @returns {FormType}
*/
ApiSignatureForm.prototype.GetFormType = function() { return new FormType(); };
...
* @returns {string}
*/
ApiSignatureForm.prototype.GetFormKey = function() { return ""; };
...
* @returns {boolean}
*/
ApiSignatureForm.prototype.SetFormKey = function(sKey) { return true; };
...
* @returns {string}
*/
ApiSignatureForm.prototype.GetTipText = function() { return ""; };
...
* @returns {boolean}
*/
ApiSignatureForm.prototype.SetTipText = function(sText) { return true; };
...
* @returns {boolean}
*/
ApiSignatureForm.prototype.IsRequired = function() { return true; };
...
* @returns {boolean}
*/
ApiSignatureForm.prototype.SetRequired = function(bRequired) { return true; };
...
* @returns {boolean}
*/
ApiSignatureForm.prototype.IsFixed = function() { return true; };
...
* @returns {boolean}
*/
ApiSignatureForm.prototype.ToFixed = function(width, height, keepPosition) { return true; };
...
* @returns {boolean}
*/
ApiSignatureForm.prototype.ToInline = function() { return true; };
...
*
*/
ApiSignatureForm.prototype.SetBorderColor = function(color) { return true; };
...
* @since 9.1.0
*/
ApiSignatureForm.prototype.GetBorderColor = function() { return new ApiColor(); };
...
*
*/
ApiSignatureForm.prototype.SetBackgroundColor = function(color) { return true; };
...
* @since 9.1.0
*/
ApiSignatureForm.prototype.GetBackgroundColor = function() { return new ApiColor(); };
...
* @returns {string}
*/
ApiSignatureForm.prototype.GetText = function() { return ""; };
...
* @since 9.4.0
*/
ApiSignatureForm.prototype.IsFilled = function() { return true; };
...
* @returns {boolean}
*/
ApiSignatureForm.prototype.Clear = function() { return true; };
...
* @returns {?ApiShape} - returns the shape in which the form is placed.
*/
ApiSignatureForm.prototype.GetWrapperShape = function() { return new ApiShape(); };
...
* @returns {boolean}
*/
ApiSignatureForm.prototype.SetPlaceholderText = function(sText) { return true; };
...
* @returns {string}
*/
ApiSignatureForm.prototype.GetPlaceholderText = function() { return ""; };
...
* @return {boolean}  
*/
ApiSignatureForm.prototype.SetTextPr = function(textPr) { return true; };
...
* @return {ApiTextPr}  
*/
ApiSignatureForm.prototype.GetTextPr = function() { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiSignatureForm.prototype.MoveCursorOutside = function(isAfter) { return true; };
...
* @returns {?ApiForm}
*/
ApiSignatureForm.prototype.Copy = function() { return new ApiForm(); };
...
* @returns {string}
*/
ApiSignatureForm.prototype.GetTag = function() { return ""; };
...
* @returns {boolean}
*/
ApiSignatureForm.prototype.SetTag = function(tag) { return true; };
...
* @returns {string}
*/
ApiSignatureForm.prototype.GetRole = function() { return ""; };
...
* @returns {boolean}
*/
ApiSignatureForm.prototype.SetRole = function(role) { return true; };
...
* @returns {boolean} - returns false if form wasn't added to the document.
*/
ApiSignatureForm.prototype.Delete = function(keepContent) { return true; };
...
* @returns {boolean} Returns true if the operation is successful.
*/
ApiSignatureForm.prototype.SetLock = function(isLock) { return true; };
...
* @returns {boolean}
*/
ApiSignatureForm.prototype.GetLock = function() { return true; };
...
* @since 8.3.0
*/
ApiBookmark.prototype.GetText = function(options) { return ""; };
...
* @returns {"textPr"}
*/
ApiRangeTextPr.prototype.GetClassType = function() { return ""; };
...
* @return {ApiTextPr} - this text properties.
*/
ApiRangeTextPr.prototype.SetStyle = function(oStyle) { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiRangeTextPr.prototype.GetStyle = function() { return new ApiStyle(); };
...
* @return {ApiTextPr} - this text properties.
*/
ApiRangeTextPr.prototype.SetBold = function(isBold) { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiRangeTextPr.prototype.GetBold = function() { return true; };
...
* @return {ApiTextPr} - this text properties.
*/
ApiRangeTextPr.prototype.SetItalic = function(isItalic) { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiRangeTextPr.prototype.GetItalic = function() { return true; };
...
* @return {ApiTextPr} - this text properties.
*/
ApiRangeTextPr.prototype.SetStrikeout = function(isStrikeout) { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiRangeTextPr.prototype.GetStrikeout = function() { return true; };
...
* @return {ApiTextPr} - this text properties.
*/
ApiRangeTextPr.prototype.SetUnderline = function(isUnderline) { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiRangeTextPr.prototype.GetUnderline = function() { return true; };
...
* @return {ApiTextPr} - this text properties.
*/
ApiRangeTextPr.prototype.SetFontFamily = function(sFontFamily) { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiRangeTextPr.prototype.GetFontFamily = function() { return ""; };
...
* @return {ApiTextPr} - this text properties.
*/
ApiRangeTextPr.prototype.SetFontSize = function(nSize) { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiRangeTextPr.prototype.GetFontSize = function() { return new hps(); };
...
*
*/
ApiRangeTextPr.prototype.SetColor = function(color) { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiRangeTextPr.prototype.GetColor = function() { return new ApiColor(); };
...
* @return {ApiTextPr} - this text properties.
*/
ApiRangeTextPr.prototype.SetVertAlign = function(sType) { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiRangeTextPr.prototype.GetVertAlign = function() { return ""; };
...
* @returns {ApiTextPr}
*/
ApiRangeTextPr.prototype.SetHighlight = function(sColor) { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiRangeTextPr.prototype.GetHighlight = function() { return ""; };
...
* @return {ApiTextPr} - this text properties.
*/
ApiRangeTextPr.prototype.SetSpacing = function(nSpacing) { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiRangeTextPr.prototype.GetSpacing = function() { return new twips(); };
...
* @return {ApiTextPr} - this text properties.
*/
ApiRangeTextPr.prototype.SetDoubleStrikeout = function(isDoubleStrikeout) { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiRangeTextPr.prototype.GetDoubleStrikeout = function() { return true; };
...
* @return {ApiTextPr} - this text properties.
*/
ApiRangeTextPr.prototype.SetCaps = function(isCaps) { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiRangeTextPr.prototype.GetCaps = function() { return true; };
...
* @return {ApiTextPr} - this text properties.
*/
ApiRangeTextPr.prototype.SetSmallCaps = function(isSmallCaps) { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiRangeTextPr.prototype.GetSmallCaps = function() { return true; };
...
* @return {ApiTextPr} - this text properties.
*/
ApiRangeTextPr.prototype.SetPosition = function(nPosition) { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiRangeTextPr.prototype.GetPosition = function() { return new hps(); };
...
* @return {ApiTextPr} - this text properties.
*/
ApiRangeTextPr.prototype.SetLanguage = function(sLangId) { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiRangeTextPr.prototype.GetLanguage = function() { return ""; };
...
*
*/
ApiRangeTextPr.prototype.SetShd = function(type, color) { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiRangeTextPr.prototype.GetShd = function() { return new Shd(); };
...
* @return {ApiTextPr} - this text properties.
*/
ApiRangeTextPr.prototype.SetTextFill = function(oApiFill) { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiRangeTextPr.prototype.GetTextFill = function() { return new ApiFill(); };
...
* @return {ApiTextPr} - this text properties.
*/
ApiRangeTextPr.prototype.SetOutLine = function(oStroke) { return new ApiTextPr(); };
...
* @since 8.1.0
*/
ApiRangeTextPr.prototype.GetOutLine = function() { return new ApiStroke(); };
...
* @returns {JSON}
*/
ApiRangeTextPr.prototype.ToJSON = function(bWriteStyles) { return new JSON(); };
